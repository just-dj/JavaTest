...
public class 生成冒险玩法奖励包_线上 {
    ...
    static {
        ...
        columnToRewardType.put("章节奖励-道兵抽奖券", Pair.of("数值资产代币(9007)", "576500"));
        columnToRewardType.put("章节奖励-法宝抽奖券", Pair.of("数值资产代币(9007)", "36000"));
    }
    ...
    public static void main(String[] args) {
        try {
            File targetFile = new File("/Users/justdj_1/Desktop/语音房宝箱数值 0906.xlsx");
